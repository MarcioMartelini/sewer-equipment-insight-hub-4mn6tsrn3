...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  not_started: { label: 'Not Started', className: 'bg-gray-100 text-gray-800 hover:bg-gray-100' },
  ...
  on_track: { label: 'On Track', className: 'bg-blue-100 text-blue-800 hover:bg-blue-100' },
  'at risk': { label: 'At Risk', className: 'bg-yellow-100 text-yellow-800 hover:bg-yellow-100' },
  at_risk: { label: 'At Risk', className: 'bg-yellow-100 text-yellow-800 hover:bg-yellow-100' },
...
export function ProductionTable({ type, woFilter, onClearFilters }: ProductionTableProps) {
